...
//   final Function(trip, BuildContext) onEdit;
//   final Function(int) onCopy;
//   final Function(trip) onDelete;
//   final VoidCallback onSave;
//
//   const DataTableWidget2({
//     super.key,
//     required this.data,
...
// }
//
// class _DataTableWidgetState extends State<DataTableWidget2> {
...
//
//   @override
//   void didUpdateWidget(DataTableWidget2 oldWidget) {
...
//     Map<String, List<trip>> tripGroups = {};
//
//     for (var supplier in widget.data) {
//       String tripKey = '${supplier.vehicleCode}-${supplier.storageName}-${supplier.procurementSpecialist}-${supplier.fleetSupervisor}';
//
//       if (!tripGroups.containsKey(tripKey)) {
//         tripGroups[tripKey] = [];
//       }
//       tripGroups[tripKey]!.add(supplier);
//     }
//
//     // Convert to TripData objects and sort suppliers within each trip
//     _trips = tripGroups.entries.map((entry) {
//       var suppliers = entry.value;
//       // Sort suppliers by arrival date within each trip
//       suppliers.sort((a, b) => a.actualArriveDate.compareTo(b.actualArriveDate));
//
//       return TripData(
//         vehicleCode: suppliers.first.vehicleCode,
//         storageName: suppliers.first.storageName,
//         procurementSpecialist: suppliers.first.procurementSpecialist,
//         fleetSupervisor: suppliers.first.fleetSupervisor,
//         suppliers: suppliers,
//       );
//     }).toList();
//
...
//                         onPressed: () => widget.onEdit(supplier, context),
...
//                         onPressed: () => widget.onDelete(supplier),
