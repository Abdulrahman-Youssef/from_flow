...
Widget buildSupplierSection(int index) {
  ...
  SupplierModel supplier = controller.suppliers[index]; // <-- Corrected
      ...
      children: [
        Row(
          ...
          children: [
            ...
            if (controller.suppliers.length > 1)
              IconButton(
          ...
          onChanged: (SupplierModel? value) {
            if (value != null) {
              controller.suppliers[index] =
                  controller.suppliers[index].copyWith(
                    id: value.id,
        ...
        SizedBox(height: 16),
        InkWell(
          onTap: () => controller.selectDateTime(index, DateType.planArrive),
        ...
        Row(
          children: [
            Expanded(
              child: InkWell(
                onTap: () =>
                    controller.selectDateTime(index, DateType.actualArrive),
                child: InputDecorator(
                  decoration: InputDecoration(
